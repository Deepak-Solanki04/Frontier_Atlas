...
const Icons = {
  ...
  Database: (props: any) => <svg xmlns="http://www.w3.org/2000/svg" width={props.size||24} height={props.size||24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={props.strokeWidth||2} strokeLinecap="round" strokeLinejoin="round" className={props.className}><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5V19A9 3 0 0 0 21 19V5"/><path d="M3 12A9 3 0 0 0 21 12"/></svg>,
  Cpu: (props: any) => <svg xmlns="http://www.w3.org/2000/svg" width={props.size||24} height={props.size||24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={props.strokeWidth||2} strokeLinecap="round" strokeLinejoin="round" className={props.className}><rect width="16" height="16" x="4" y="4" rx="2" ry="2"/><rect width="6" height="6" x="9" y="9" rx="1" ry="1"/><path d="M15 2v2"/><path d="M15 20v2"/><path d="M2 15h2"/><path d="M2 9h2"/><path d="M20 15h2"/><path d="M20 9h2"/><path d="M9 2v2"/><path d="M9 20v2"/></svg>
};
...
<span className="text-[#9333EA]">print</span>(response.choices[<span className="text-[#EA580C]">0</span>].message.content)</code></pre>
         ...
         {/* ── SYSTEM ARCHITECTURE ── */}
         <div className="mb-16">
            <h2 className="text-[27px] font-bold text-[#111827] mb-6">System Architecture</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
               <div className="bg-white border border-[#EAE9E4] rounded-[16px] shadow-sm p-6 flex flex-col gap-4 hover:border-[#FF5A1F] transition-colors">
                  ...
                  <div>
                     <h4 className="text-[15.5px] font-bold text-[#111111] mb-2">Sparse Mixture of Experts (MoE)</h4>
               ...
               <div className="bg-white border border-[#EAE9E4] rounded-[16px] shadow-sm p-6 flex flex-col gap-4 hover:border-[#FF5A1F] transition-colors">
                  ...
                  <div>
                     <h4 className="text-[15.5px] font-bold text-[#111111] mb-2">15 Trillion Training Tokens</h4>
                     <p className="text-[13.5px] text-[#666] leading-relaxed">
               ...
               <div className="bg-white border border-[#EAE9E4] rounded-[16px] shadow-sm p-6 flex flex-col gap-4 hover:border-[#FF5A1F] transition-colors">
                  ...
                  <div>
                     <h4 className="text-[15.5px] font-bold text-[#111111] mb-2">Grouped-Query Attention (GQA)</h4>
                     <p className="text-[13.5px] text-[#666] leading-relaxed">
