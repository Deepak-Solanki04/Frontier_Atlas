...
function getOrgLogo(orgOrLeader: string): string {
  ...
  if (lower.includes("qwen") || lower.includes("alibaba")) {
    return 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="%23ff6a00"><circle cx="12" cy="12" r="10" fill="%23ff6a00"/><path d="M7 12l3 3 7-7" stroke="%23ffffff" stroke-width="3" fill="none" stroke-linecap="round"/></svg>';
  }
  ...
  if (lower.includes("microsoft") || lower.includes("phi")) {
