...
import { getCardDescription } from "@/lib/cardDescriptions";
                  ...
                  {filteredCapabilities.map((cap, idx) => {
                    ...
                    return (
                      <div
                        ...
                        className={`bg-white rounded-[12px] border-[2px] p-5 min-h-[150px] flex flex-col transition-shadow duration-200 group no-underline cursor-pointer ${isActive ? 'border-[#FF5A1F] shadow-[0_0_0_1px_#FF5A1F] bg-[#FFF6F3]' : 'border-[#ECECEC] hover:shadow-md' }`}
                      >
                  ...
                  {filteredTrending.map((m, idx) => {
                    ...
                    return (
                      <div
                        ...
                        className="bg-white rounded-[12px] border-[2px] border-[#ECECEC] p-5 min-h-[150px] flex flex-col hover:shadow-md transition-shadow duration-200 group no-underline"
                      >
                        <div className="flex items-start gap-4">
                          <div className="flex items-center justify-center transition-transform duration-200 group-hover:scale-125">
                            {modelLogo ? (
