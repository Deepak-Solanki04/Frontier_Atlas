                ...
                <div className="px-4 pt-6 pb-4">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-3 py-2 text-sm font-medium tracking-tight text-gray-800 placeholder:text-gray-400 rounded-sm border border-gray-200 focus:outline-none focus:border-rose-400 focus:ring-1 focus:ring-rose-400 bg-white/80 transition-colors"
                      value={searchQuery}
