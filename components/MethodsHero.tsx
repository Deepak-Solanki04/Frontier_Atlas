  ...
  return (
    <section className="mb-16">
      <div className="max-w-xl">
        <h1 className="text-[36px] font-extrabold tracking-tight text-[#111827] leading-none">
          All <span className="text-[#F55036]">Methods</span>
        </h1>

        <p className="mt-5 text-[16px] text-gray-600 leading-2">
        ...
        <div className="flex items-center gap-10 mt-4">
          <div>
            ...
            <div className="text-[16px] text-gray-500 mt-1">Categories</div>
          </div>

          <div>
            <div className="text-3xl font-bold">{totalMethods}</div>
            <div className="text-[16px] text-gray-500 mt-1">Methods</div>
          </div>
          ...
          <div>
            ...
            <div className="text-[16px] text-gray-500 mt-1">Papers</div>
          </div>
        </div>
      </div>
    </section>
