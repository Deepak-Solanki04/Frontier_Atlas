  ...
  return (
    <section className="mb-16">
      <div className="max-w-xl">
        <h1 className="text-[35px] font-extrabold tracking-tight text-[#111827] leading-none">
        ...
        <div className="flex items-center gap-10 mt-4">
          <div>
            <div className="text-[27px] font-bold">{totalCategories}</div>
            <div className="text-[15.5px] text-gray-500 mt-1">Categories</div>
          </div>

          <div>
            <div className="text-[27px] font-bold">{totalMethods}</div>
            <div className="text-[15.5px] text-gray-500 mt-1">Methods</div>
          </div>
          ...
          <div>
            ...
            <div className="text-[15.5px] text-gray-500 mt-1">Papers</div>
          </div>
        </div>
      </div>
    </section>
