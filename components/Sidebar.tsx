      ...
      <div className="sidebar-nav">
        ...
        <div className="nav-section">
          ...
          <Link href="/trending" className={`nav-item ${isActive('/trending')}`}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M13.5.67s.74 2.65.74 4.8c0 2.06-1.35 3.73-3.41 3.73-2.07 0-3.63-1.67-3.63-3.73l.03-.36C5.21 7.51 4 10.62 4 14c0 4.42 3.58 8 8 8s8-3.58 8-8C20 8.61 17.41 3.8 13.5.67zM11.71 19c-1.78 0-3.22-1.4-3.22-3.14 0-1.62 1.05-2.76 2.81-3.12 1.77-.36 3.6-1.21 4.62-2.58.39 1.29.59 2.65.59 4.04 0 2.65-2.15 4.8-4.8 4.8z"/></svg>
            Trending Papers
          </Link>
        ...
        <div className="nav-section">
          ...
          <Link href="/agents" className={`nav-item ${isActive('/agents')}`}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2a2 2 0 012 2c0 .74-.4 1.39-1 1.73V7h1a7 7 0 017 7h1v2h-1v1a2 2 0 01-2 2H4a2 2 0 01-2-2v-1H1v-2h1a7 7 0 017-7h1V5.73c-.6-.34-1-.99-1-1.73a2 2 0 012-2zM9 10a2 2 0 00-2 2v2a2 2 0 002 2h6a2 2 0 002-2v-2a2 2 0 00-2-2H9z"/></svg>
            Agents
          </Link>
          <Link href="/reasoning" className={`nav-item ${isActive('/reasoning')}`}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M11.5 2C6.81 2 3 5.81 3 10.5S6.81 19 11.5 19h.5v3c4.86-2.34 8-7 8-11.5C20 5.81 16.19 2 11.5 2zm1 14.5h-2v-2h2v2zm0-4h-2c0-3.25 3-3 3-5 0-1.1-.9-2-2-2s-2 .9-2 2h-2c0-2.21 1.79-4 4-4s4 1.79 4 4c0 2.5-3 2.75-3 5z"/></svg>
            Reasoning
          </Link>
          ...
          <Link href="/computer-use" className={`nav-item ${isActive('/computer-use')}`}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M21 2H3c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h7v2H8v2h8v-2h-2v-2h7c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H3V4h18v12z"/></svg>
            Computer Use
          </Link>
        ...
        <div className="nav-section">
          ...
          <Link href="/chain-of-thought" className={`nav-item ${isActive('/chain-of-thought')}`}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M20 2H4c-1.103 0-2 .897-2 2v18l5.333-4H20c1.103 0 2-.897 2-2V4c0-1.103-.897-2-2-2zm-9 9H7V9h4v2zm6 0h-4V9h4v2z"/></svg>
            Chain of Thought
          </Link>
          <Link href="/react" className={`nav-item ${isActive('/react')}`}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M7 2v11h3v9l7-12h-4l4-8z"/></svg>
            ReAct
          </Link>
          ...
          <Link href="/mcp" className={`nav-item ${isActive('/mcp')}`}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M17 12h-4V8h-2v4H7l5 5 5-5zm-5-10C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/></svg>
            MCP
          </Link>
        </div>
        ...
        <div className="nav-section">
          ...
          <Link href="/video-generation" className={`nav-item ${isActive('/video-generation')}`}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18 4l2 4h-3l-2-4h-2l2 4h-3l-2-4H8l2 4H7L5 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V4h-4z"/></svg>
            Video Generation
          </Link>
        ...
        <div className="nav-section">
          ...
          <Link href="/collections" className={`nav-item ${isActive('/collections')}`}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M4 6H2v14c0 1.1.9 2 2 2h14v-2H4V6zm16-4H8c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-1 9h-4v4h-2v-4H9V9h4V5h2v4h4v2z"/></svg>
            Collections
          </Link>
        </div>
