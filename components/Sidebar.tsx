      ...
      <div className="sidebar-nav">
        ...
        <div className="nav-section">
          ...
          <Link href="/latest-papers" className={`nav-item ${isActive('/latest-papers')}`}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 15 9"/></svg>
            Latest Papers
          </Link>
          <Link href="/most-github-stars" className={`nav-item ${isActive('/most-github-stars')}`}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/><path d="M12 7v5l3 2" strokeWidth="1.5"/></svg>
            Most GitHub Stars
          </Link>
        </div>
        ...
        <div className="nav-section">
          ...
          <Link href="/world-models" className={`nav-item ${isActive('/world-models')}`}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="7" cy="7" r="3.5"/><circle cx="17" cy="7" r="3.5"/><circle cx="17" cy="17" r="3.5"/><circle cx="7" cy="17" r="3.5"/></svg>
            World Models
          </Link>
        ...
        <div className="nav-section">
          ...
          <Link href="/transformer" className={`nav-item ${isActive('/transformer')}`}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="16" height="16" x="4" y="4" rx="2"/><rect width="6" height="6" x="9" y="9" rx="1"/><path d="M15 2v2M15 20v2M2 15h2M2 9h2M20 15h2M20 9h2M9 2v2M9 20v2"/></svg>
            Transformer
          </Link>
          ...
          <Link href="/react" className={`nav-item ${isActive('/react')}`}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10 2v7.527a2 2 0 0 1-.211.896L4.72 20.55a1 1 0 0 0 .9 1.45h12.76a1 1 0 0 0 .9-1.45l-5.069-10.127A2 2 0 0 1 14 9.527V2"/><path d="M8.5 2h7"/><path d="M7 16h10"/></svg>
            ReAct
          </Link>
        ...
        <div className="nav-section">
          ...
          <Link href="/text-generation" className={`nav-item ${isActive('/text-generation')}`}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="21" x2="7" y1="6" y2="6"/><line x1="17" x2="7" y1="12" y2="12"/><line x1="19" x2="7" y1="18" y2="18"/><path d="M3 6v12"/><circle cx="3" cy="12" r="1.5"/></svg>
            Text Generation
          </Link>
          <Link href="/image-generation" className={`nav-item ${isActive('/image-generation')}`}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><circle cx="12" cy="12" r="3.5"/></svg>
            Image Generation
          </Link>
          <Link href="/video-generation" className={`nav-item ${isActive('/video-generation')}`}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polygon points="10 9 16 12 10 15" fill="currentColor"/></svg>
            Video Generation
          </Link>
          <Link href="/audio-generation" className={`nav-item ${isActive('/audio-generation')}`}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="6.5" y1="14" x2="17.5" y2="14"/><line x1="9" y1="9" x2="15" y2="9"/></svg>
            Audio Generation
          </Link>
        </div>
