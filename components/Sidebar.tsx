    ...
    <aside className="sidebar-full">
      <div className="sidebar-nav">
        <div className="nav-section">
          ...
          {/* Trending Papers — orange fire flame */}
        ...
        <div className="nav-section">
          ...
          <Link href="/agents" className={`nav-item ${isActive('/agents')}`}>
            <svg viewBox="0 0 24 24" fill="currentColor" stroke="none" style={{color: '#3b82f6'}}><path d="M12 2a2 2 0 012 2c0 .74-.4 1.39-1 1.73V7h1a7 7 0 017 7h1v2h-1v1a2 2 0 01-2 2H4a2 2 0 01-2-2v-1H1v-2h1a7 7 0 017-7h1V5.73c-.6-.34-1-.99-1-1.73a2 2 0 012-2zM9 10a2 2 0 00-2 2v2a2 2 0 002 2h6a2 2 0 002-2v-2a2 2 0 00-2-2H9z"/></svg>
            Agents
          </Link>
          {/* Reasoning — orange brain */}
          <Link href="/reasoning" className={`nav-item ${isActive('/reasoning')}`}>
            <svg viewBox="0 0 24 24" fill="currentColor" stroke="none" style={{color: '#f97316'}}><path d="M15.5 14h-.79l-.28-.27A6.471 6.471 0 0016 9.5 6.5 6.5 0 109.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"/></svg>
            Reasoning
          </Link>
          {/* Language Modeling — green document/page */}
          <Link href="/language-modeling" className={`nav-item ${isActive('/language-modeling')}`}>
            <svg viewBox="0 0 24 24" fill="currentColor" stroke="none" style={{color: '#10b981'}}><path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/></svg>
            Language Modeling
          </Link>
          ...
          {/* Computer Use — purple cursor arrow */}
          <Link href="/computer-use" className={`nav-item ${isActive('/computer-use')}`}>
            <svg viewBox="0 0 24 24" fill="currentColor" stroke="none" style={{color: '#8b5cf6'}}><path d="M13.773 15.025l3.552 6.271-2.009 1.139-3.552-6.272-4.132 3.465V2l11.573 11.025h-5.432z"/></svg>
            Computer Use
          </Link>
        ...
        <div className="nav-section">
          ...
          {/* Transformer — blue network/hub */}
          <Link href="/transformer" className={`nav-item ${isActive('/transformer')}`}>
            <svg viewBox="0 0 24 24" fill="currentColor" stroke="none" style={{color: '#3b82f6'}}><path d="M17 16l-4-4V8.82C14.16 8.4 15 7.3 15 6c0-1.66-1.34-3-3-3S9 4.34 9 6c0 1.3.84 2.4 2 2.82V12l-4 4H3v5h5v-3.05l4-4.2 4 4.2V21h5v-5h-4z"/></svg>
            Transformer
          </Link>
          {/* Chain of Thought — purple chain link */}
        ...
        <div className="nav-section">
          ...
          <Link href="/text-generation" className={`nav-item ${isActive('/text-generation')}`}>
            <svg viewBox="0 0 24 24" fill="currentColor" stroke="none" style={{color: '#3b82f6'}}><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>
            Text Generation
          </Link>
          {/* Image Generation — green landscape */}
          ...
          {/* Video Generation — purple video camera */}
